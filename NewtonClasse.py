...
class NewtonClasse :
    def __init__(self,fenetre5):
        ...
        #-----------------le coleure de bag-----------------------------------#
        self.fenetre5.config(bg="#DEDCDA")   
        ...
        #==============Frame1  ===============================================#
        frame1=Frame( self.fenetre5, bg="#DEDCDA", highlightbackground="green",highlightthickness=2)
        frame1.place(x=45,y=40,height=660,width=900)
        #===============title=================================================#
        title = Label( self.fenetre5,text="Newton Search",font=("Comic Sans MS", 17,"bold"), bg="#DEDCDA",fg="green").place(x=400,y=5)
       
        #----------------les entrer de l'algorithme---------------------------#
        entrer = Label(frame1,text="Input { ",font=("Comic Sans MS", 15,"bold"), bg="#DEDCDA",fg="#182350").place(x=10,y=10)
        
        #=================l'intervale ========================================#
        intervale = Label(frame1,text="The interval [a , b]   :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=110,y=20)
        
        #================vale de a ===========================================#
        val_a = Label(frame1,text=" a :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=400,y=20)
        ...
        #================la valeure de b =====================================#
        val_b = Label(frame1,text=" b :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=630,y=20)
        ...
        #===================la fonction=======================================#
        fonc = Label(frame1,text="Function               : ",font=("Comic Sans MS", 16,"bold"),bg="#DEDCDA").place(x=110,y=80)
        foncF = Label(frame1,text="f(x)  =",font=("Comic Sans MS", 16,"bold"),bg="#DEDCDA").place(x=360,y=80)
        self.txt_fonc = Entry(frame1,font=("times new romman", 17,"bold"), bg="lightgray",fg="#182350")
        self.txt_fonc.place(x=440,y=83,width=397 )
        
        #================la tolérence  =======================================#
        delta = Label(frame1,text="Tolerance              :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=110,y=140)
        delTTa = Label(frame1,text="delta =",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=360,y=140)
        ...
        nbriteramax = Label(frame1,text="Number of iterations :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=110,y=200)
        nbriteramax = Label(frame1,text="imax =",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA").place(x=360,y=200)
        ...
        #==============self.frame2  ===============================================#
        self.frameVois=Frame( frame1,bg="#C4C6C6" ,highlightbackground="#182350",highlightthickness=3)
        ...
        #=================fermer l'accolade===================================#
        coladfer = Label(frame1,text=" } Output   :",font=("Comic Sans MS", 15,"bold"),bg="#DEDCDA",fg="#182350").place(x=10,y=360)
        ...
        self.txt_iterpretaNewton = Entry(self.frame2,font=("times new romman",17,"bold"), bg="lightgray",fg="#182350", textvariable=self.var_iterpreNewton)
        ...
        Fibonacci_Button  = Button(self.frameVois,font=("times new romman",14,"bold"),text=" Fibonacci ",bd=0,cursor="hand2",bg="#11A370",fg="#E5E1D6",activebackground ="#7AA1E6",activeforeground="#BF846C",borderwidth = 2, command =self.fibonacciNewton).place(x=50 ,y=50,width=150)
          
        #============================================================ boutton Dichotomique la recherche de voisinage ====================================================================================================#
        dico_button = Button(self.frameVois,font=("times new romman",14,"bold"),text=" Dichotomous ",bd=0,cursor="hand2",bg="#8E3443",fg="#E5E1D6",activebackground ="#BFB3B5",activeforeground="#E5E1D6",borderwidth = 2,command=self.dichotomiqueNewton).place(x=250 ,y=50,width=150)
        
        #=========================================================== boutton Section d'or la recherche de voisinage =====================================================================================================#
        SectionDor_Button  = Button(self.frameVois,font=("times new romman",14,"bold"),text=" Section d'or ",bd=0,cursor="hand2",bg="#AFAF0D",fg="#E5E1D6",activebackground ="#7AA1E6",activeforeground="#BF846C",borderwidth = 2, command =self.SectionDoreeNewton).place(x=450 ,y=50,width=150)
        
        #============================================================ Bouton Bissection la recherche de voisinage =======================================================================================================#
        Bissection_boutton = Button(self.frameVois,font=("times new romman",14,"bold"),text=" Bissection ",bd=0,cursor="hand2",bg="#0575B0",fg="#E5E1D6",activebackground ="#AFAF0D",activeforeground="#0F5A7D",borderwidth = 2, command=self.BissectionNewton).place(x=650 ,y=50,width=150)
