...
class Dichotomique :
    def __init__(self,fenetre2):
        ...
        #-----------------le coleure de bag-----------------------------------#
        self.fenetre2.config(bg="#D8E1B6")   
        ...
        #==============Frame1  ===============================================#
        frame1=Frame( self.fenetre2, bg="#D8E1B6", highlightbackground="green",highlightthickness=2)
        frame1.place(x=45,y=40,height=660,width=900)
        #===============title=================================================#
        title = Label( self.fenetre2,text="Dichotomous Search",font=("Comic Sans MS", 17,"bold"), bg="#D8E1B6",fg="green").place(x=350,y=5)
       
        #----------------les entrer de l'algorithme---------------------------#
        entrer = Label(frame1,text="Input { ",font=("Comic Sans MS", 15,"bold"), bg="#D8E1B6",fg="#182350").place(x=10,y=10)
        
        #=================l'intervale ========================================#
        intervale = Label(frame1,text="The interval [a , b]   :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=110,y=20)
        
        #================vale de a ===========================================#
        val_a = Label(frame1,text=" a :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=400,y=20)
        ...
        #================la valeure de b =====================================#
        val_b = Label(frame1,text=" b :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=630,y=20)
        ...
        #===================la fonction=======================================#
        fonc = Label(frame1,text="Function               : ",font=("Comic Sans MS", 16,"bold"),bg="#D8E1B6").place(x=110,y=80)
        foncF = Label(frame1,text="f(x)  =",font=("Comic Sans MS", 16,"bold"),bg="#D8E1B6").place(x=360,y=80)
        self.txt_fonc = Entry(frame1,font=("times new romman", 17,"bold"), bg="lightgray",fg="#182350")
        self.txt_fonc.place(x=440,y=83,width=397 )
        
        #================la tolérence  =======================================#
        delta = Label(frame1,text="Tolerance              :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=110,y=140)
        delTTa = Label(frame1,text="delta =",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=360,y=140)
        ...
        nbriteramax = Label(frame1,text="Number of iterations :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=110,y=200)
        nbriteraMax = Label(frame1,text="imax =",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6").place(x=360,y=200)
        ...
        #=================fermer l'accolade===================================#
        coladfer = Label(frame1,text=" } Output   :",font=("Comic Sans MS", 15,"bold"),bg="#D8E1B6",fg="#182350").place(x=10,y=260)
