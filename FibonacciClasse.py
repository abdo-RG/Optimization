...
class Fibonacci :
    def __init__(self,fenetre3):
        ...
        #-----------------le coleure de bag-----------------------------------#
        self.fenetre3.config(bg="#D4DCD8")   
        ...
        #==============Frame1  ===============================================#
        frame1=Frame( self.fenetre3, bg="#D4DCD8", highlightbackground="green",highlightthickness=2)
        frame1.place(x=45,y=40,height=660,width=900)
        #===============title=================================================#
        title = Label( self.fenetre3,text="Fibonacci Search",font=("Comic Sans MS", 17,"bold"), bg="#D4DCD8",fg="green").place(x=390,y=5)
       
        #----------------les entrer de l'algorithme---------------------------#
        entrer = Label(frame1,text="Input { ",font=("Comic Sans MS", 15,"bold"), bg="#D4DCD8",fg="#182350").place(x=10,y=10)
        
        #=================l'intervale ========================================#
        intervale = Label(frame1,text="The interval [a , b]   :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=110,y=20)
        
        #================vale de a ===========================================#
        self.val_a = Label(frame1,text=" a :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=400,y=20)
        ...
        #================la valeure de b =====================================#
        self.val_b = Label(frame1,text=" b :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=630,y=20)
        ...
        #===================la fonction=======================================#
        self.fonc = Label(frame1,text="Function               : ",font=("Comic Sans MS", 16,"bold"),bg="#D4DCD8").place(x=110,y=80)
        self.foncF = Label(frame1,text="f(x)  =",font=("Comic Sans MS", 16,"bold"),bg="#D4DCD8").place(x=360,y=80)
        self.txt_fonc = Entry(frame1,font=("times new romman", 17,"bold"), bg="lightgray",fg="#182350")
        self.txt_fonc.place(x=440,y=83,width=397 )
        
        #================la tolérence  =======================================#
        self.delta = Label(frame1,text="Tolerance              :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=110,y=140)
        self.delTTa = Label(frame1,text="delta =",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=360,y=140)
        ...
        self.nbriteramax = Label(frame1,text="Number of iterations :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=110,y=200)
        self.nbriteramax = Label(frame1,text="imax =",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8").place(x=360,y=200)
        ...
        #=================fermer l'accolade===================================#
        self.coladfer = Label(frame1,text=" } Output   :",font=("Comic Sans MS", 15,"bold"),bg="#D4DCD8",fg="#182350").place(x=10,y=260)
        ...
        #=========================================================== boutton Fibonacci =========================================================================================================#
        Fibonacci_Button  = Button(frame2,font=("times new romman",16,"bold"),text=" Fibonacci ",bd=0,cursor="hand2",bg="#11A370",fg="#E5E1D6",activebackground ="#7AA1E6",activeforeground="#BF846C",borderwidth = 5, command = self.fibonacci).place(x=320 ,y=270,width=270)
